...
/***/ function(module, exports, __webpack_require__) {
	...
	var angular2_1 = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".logo{width:150px;height:150px}.repo-description{height:100px;overflow-y:auto}.progress{position:absolute;margin-top:0}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var angular2_1 = __webpack_require__(16);
	var http_1 = __webpack_require__(107);
	var angular2_2 = __webpack_require__(16);
	var _ = __webpack_require__(273);
	...
	var App = (function () {
	    function App(http) {
	        ...
	        this.searchInput = _.debounce(this.searchRepos, 500);
	        this.searchStr = '';
	    }
	    App.prototype.searchRepos = function () {
	        var _this = this;
	        this.showProgressBar = true;
	        var url = "https://api.github.com/search/repositories?q=" + this.searchStr;
	        ...
	        this.http
	            ...
	            _this.repos = data.items;
	        }, function (err) { return console.error(err); }, function () { return _this.showProgressBar = false; });
	    };
	    App = __decorate([
