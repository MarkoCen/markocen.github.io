    ...
    module.directive('dirDisqus', ['$window', function($window) {
        return {
            ...
            link: function(scope) {
                ...
                //if (typeof scope.disqusIdentifier === 'undefined' || typeof scope.disqusUrl === 'undefined') {
                ...
                scope.$watch("readyToBind", function(isReady) {
                    ...
                    if (isReady) {
                        ...
                        $window.disqus_shortname = scope.disqusShortname;
                        $window.disqus_identifier = scope.disqusIdentifier;
                        $window.disqus_title = scope.disqusTitle;
                        $window.disqus_url = scope.disqusUrl;
                        ...
                        if (!$window.DISQUS) {
                            ...
                            $window.DISQUS.reset({
                                reload: true,
                                config: function () {
                                    this.page.identifier = scope.disqusIdentifier;
                                    this.page.url = scope.disqusUrl;
                                    this.page.title = scope.disqusTitle;
                                    this.language = scope.disqus_config_language;
                                }
                            });
                        }
